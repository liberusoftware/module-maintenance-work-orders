...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-maintenance-work-orders?sort=semver)](https://github.com/liberusoftware/module-maintenance-work-orders/releases/latest) [![Tests](https://github.com/liberusoftware/module-maintenance-work-orders/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-maintenance-work-orders/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-maintenance-work-orders
```
...
<a href="https://github.com/liberusoftware/module-maintenance-work-orders/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-maintenance-work-orders" alt="Contributors to liberusoftware/module-maintenance-work-orders">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-maintenance-work-orders/graphs/contributors).
